var window = {};
var document = {};
// var TOKEN_SERVER_TIME = 1668148000.217;
//因为函数体内可能出现参数名和一开始定义的数组参数名一样，但是作用域不一样，要查看那些数组对应哪一个
//长度239
...
var qn = function () {
    ...
    return l["prototype"]["toBuffer"] = function () {
        for (var a = e[105], u = this["base_fileds"], c = [], s = -e[0], v = o[2], f = u[r[56]]; v < f; v++)
...
function strhash() {
    ...
    var o, i, u, r;
    o = i = u = r = diyi;
    var n = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36';
